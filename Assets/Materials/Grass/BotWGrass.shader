Shader "Custom/BotWGrass"
{
	Properties
	{
		...
		_BladeWidthMin("Blade Width (Min)", Float) = 0.02
		_BladeWidthMax("Blade Width (Max)", Float) = 0.05
		_BladeHeightMin("Blade Height (Min)", Float) = 0.1
		_BladeHeightMax("Blade Height (Max)", Float) = 0.2
